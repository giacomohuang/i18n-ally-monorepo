...
<p align='center'>
<b>Fork version v2.14.0</b> adds first-class monorepo project support.
</p>
...
<h3 align='center'>Monorepo Projects</h3>

This fork supports monorepo workspaces through `i18n-ally.projects`. Each project can define its own root, locale paths, languages, frameworks, parsers and path matching rules. i18n Ally selects the matching project by the active file path, so translation analysis, extraction, completion and locale file loading stay scoped to the current app or package.
