...
<p align='center'>
<b>Fork 版本 v2.14.0</b> 增加了 Monorepo 项目支持。
</p>
...
这个 fork 版本支持通过 `i18n-ally.projects` 配置 Monorepo 工作区。每个项目都可以独立设置根目录、语言目录、语言、框架、解析器和路径匹配规则。i18n Ally 会根据当前打开文件的路径自动选择匹配项目，让翻译分析、提取、补全和语言文件加载都限定在当前应用或包内。
